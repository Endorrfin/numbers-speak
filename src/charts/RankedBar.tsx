...
export function RankedBar({ rows, label, tickFormat }: Props) {
  ...
  useEffect(() => {
    ...
    return renderRankedBar(svg, rows, { width, reducedMotion, tickFormat, tooltip: tipRef.current });
  }, [rows, width, reducedMotion, tickFormat]);
